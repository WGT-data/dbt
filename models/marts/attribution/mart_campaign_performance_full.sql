...
, combined AS (
    SELECT 
        ...
        -- Total Revenue
        , COALESCE(c.COHORT_LIFETIME_REVENUE, 0) AS COHORT_LIFETIME_REVENUE
...
SELECT
    ...
    , CASE WHEN COST > 0 THEN COHORT_LIFETIME_REVENUE / COST ELSE NULL END AS TOTAL_ROAS
    ...
    , CASE WHEN ATTRIBUTION_INSTALLS > 0
        THEN COHORT_LIFETIME_REVENUE / ATTRIBUTION_INSTALLS
    ...
    , CASE WHEN TOTAL_PAYING_USERS > 0
        THEN COHORT_LIFETIME_REVENUE / TOTAL_PAYING_USERS
