-- mart_network_performance_mta.sql
-- Network-level performance metrics with ALL attribution models
-- Aggregates to AD_PARTNER + PLATFORM + DATE (no campaign dimension)
-- Resolves campaign name mismatch between spend and MTA data sources
--
...
-- =============================================
-- ADJUST METRICS AGGREGATED (baseline) at Network level
-- =============================================
, adjust_metrics AS (
    SELECT
...
-- =============================================
-- MTA METRICS AGGREGATED (all 5 models) at Network level
-- =============================================
, mta_metrics AS (
    SELECT
...
-- Join on AD_PARTNER + PLATFORM + DATE (no CAMPAIGN_NAME)
-- =============================================
, combined AS (
    SELECT
