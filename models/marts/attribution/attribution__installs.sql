...
, REVENUE_ATTRIBUTED AS (
    ...
    GROUP BY BI.NETWORK_NAME, BI.CAMPAIGN_ID, BI.ADGROUP_ID, BI.INSTALL_DATE
)
...
, INSTALL_SUMMARY AS (
    ...
    FROM BASE_INSTALLS
    GROUP BY NETWORK_NAME, CAMPAIGN_NAME, CAMPAIGN_ID, ADGROUP_NAME, ADGROUP_ID, PLATFORM, INSTALL_DATE
)
