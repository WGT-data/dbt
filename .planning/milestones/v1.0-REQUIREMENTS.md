# Requirements Archive: v1.0 Data Integrity
...
- [x] **FRESH-01**: Source freshness configured for Adjust sources with appropriate loaded_at_field or proxy timestamp — Phase 6 complete (13 S3 + 1 API table)
- [x] **FRESH-02**: Source freshness configured for Amplitude sources with appropriate loaded_at_field or proxy timestamp — Phase 6 complete (metadata-based)
- [x] **FRESH-03**: Stale static table detection alerts when ADJUST_AMPLITUDE_DEVICE_MAPPING hasn't been refreshed in >30 days — Phase 6 complete (INFORMATION_SCHEMA test)
- [x] **FRESH-04**: Source freshness runs as scheduled job (separate from model builds) — Phase 6 complete (dbt Cloud every 6h)
...
| FRESH-01 | Phase 6 | Complete |
| FRESH-02 | Phase 6 | Complete |
| FRESH-03 | Phase 6 | Complete |
| FRESH-04 | Phase 6 | Complete |
